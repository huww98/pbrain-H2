...
namespace Huww98.FiveInARow.Engine.Tests
{
    public class MoveGeneratorTests
    {
        ...
        private static void Init(out Board board, out MoveGenerator moveGenerator, out IOrderedEnumerable<int> expectedMoves)
        {
            var array = new Player[10, 10];
            array[1, 2] = Player.Own;
            var newBoard = new Board(array);
            moveGenerator = new MoveGenerator(newBoard, range: 1);
